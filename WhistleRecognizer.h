 ...
 *
volumeThreshold = 0.4;
timeForOneChannelAcceptance = 600;
...
MODULE(WhistleRecognizer)
  ...
  LOADS_PARAMETER(int,   timeForOneChannelAcceptance) /**< After having heard the whistle on both channels, this is the amount of time in which one channel is still sufficient */
  LOADS_PARAMETER(bool,  deactivatePlots)             /**< Unimportant flag */
  LOADS_PARAMETER(std::string, whistleFile)           /**< Name of the file that stores the reference whistle */
END_MODULE
/*
